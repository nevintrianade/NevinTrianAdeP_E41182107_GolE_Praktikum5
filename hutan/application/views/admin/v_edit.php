...
<div class="panel-heading">
	...
	<?php foreach($user as $u){ ?> <!-- mengubah $user menjadi $u  -->
		<?php echo form_open_multipart('admin/user/update');?>  <!-- meneruskan input form ke direktori file crud/update dengan method post  -->
	<table class="table table-bordered"> <!-- membuat tabel  -->
			...
			<tr>
				<td>FOTO</td>
				<input type="hidden" name="old_FOTO" value="<?php echo $u->FOTO ?>" /> </td>
